...
module.exports = function(file) {
    ...
    lines = lines.map(function(line, index) {
        ...
        // normalize comments before processing // ******* buggy needs fixed *******///
         ...
         */
        line = line.replace(/\bdefault\b(?!\:)/, 'default:');
        ...
        /**
         * Replaces object literal syntax with vanilla
         * Optional inherits keyword connects __proto__
         * $0 matches `object foo inherits bar`
         * $1 matches `foo`
         * $2 matches `bar`
         */
        line = line.replace(objLit, function($0, $1, $2) {
